...
test("US20: Add Participants to Event Form", async ({}, testInfo) => {
  ...
  await test.step("Fill input attendees form", async () => {
    ...
    await eventForm.checkManuallyRegister();
    ...
    await eventForm.deleteSelectedResident();
    await wait(100);
    await testInfo.attach("Delete selected resident", {
      body: await page.screenshot(),
      contentType: "image/png",
    });
